...
system = CheckInSystem(debug_level=DEBUG_LEVEL, db_name=DB_NAME, should_run_thread=SHOULD_RUN_THREAD)
...
def register():
    ...
    error_code = system.add_reservation(first_name, last_name, reservation_number)
...
def delete_reservation():
    ...
    error_code = system.delete_reservation_by_name(reservation_number)
    if  error_code != ErrorCode.SUCCESS:
